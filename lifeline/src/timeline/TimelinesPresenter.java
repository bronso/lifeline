...
import timeline.TimelinesView.Delta;
import timeline.TimelinesView.ZoomTimer;
...
public class TimelinesPresenter {
	...
	public Pane createNode(){ //lager xml. Håper å senere få lagt dette i xml fil.
		...
		//TimelineFrameLine l= lines.addLine(30);
		//lines.addLine(50);
		
		//l.getChildren().add(timelines);
	...
	public TimelinesPresenter(double w,TimelineParameters p){
		par=p;
		viewPortWidth=w;
		timelines=new ArrayList<Timeline>();
		createNode(); //lager node
		enableDrag(); //legger på event handles
